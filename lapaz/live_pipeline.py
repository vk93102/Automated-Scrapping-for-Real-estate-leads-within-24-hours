...
# Allow running as: python lapaz/live_pipeline.py
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))

from lapaz.extractor import (  # noqa: E402
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="La Paz County, AZ — end-to-end leads pipeline"
    )
    ...
    print("\n============================================================")
    print(" LA PAZ COUNTY AZ — REAL ESTATE LEADS PIPELINE")
    print("============================================================")
