        ...
        for r in records:
            ...
            cur.execute(
                ...
                INSERT INTO coconino_leads (
                    ...
                    image_urls, ocr_text_path, ocr_method, ocr_chars,
                    used_groq, groq_model, groq_error, analysis_error,
                    manual_review, manual_review_reasons, manual_review_summary, manual_review_context,
                    run_date, raw_record, metadata
                ) VALUES (
                    ...
                    %(image_urls)s, %(ocr_text_path)s, %(ocr_method)s, %(ocr_chars)s,
                    %(used_groq)s, %(groq_model)s, %(groq_error)s, %(analysis_error)s,
                    %(manual_review)s, %(manual_review_reasons)s, %(manual_review_summary)s, %(manual_review_context)s,
                    %(run_date)s, %(raw_record)s, %(metadata)s
                )
