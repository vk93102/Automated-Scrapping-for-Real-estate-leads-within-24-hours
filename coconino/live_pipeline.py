...
# Allow running as: python3 "coconino/live_pipeline.py"
THIS_DIR = Path(__file__).resolve().parent
sys.path.insert(0, str(THIS_DIR))
sys.path.insert(0, str(THIS_DIR.parent))

from extractor import DEFAULT_DOCUMENT_TYPES, run_coconino_pipeline  # noqa: E402
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Coconino County, AZ — end-to-end leads pipeline"
    )
    ...
    print("\n============================================================")
    print(" COCONINO COUNTY AZ — REAL ESTATE LEADS PIPELINE")
    print("============================================================")
    print(f" Date Range : {args.start_date} -> {args.end_date}")
    print(f" Doc Types  : {len(args.doc_types)}")

    res = run_coconino_pipeline(
