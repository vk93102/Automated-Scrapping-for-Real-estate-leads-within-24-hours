...
from navajo.extractor import DEFAULT_DOCUMENT_TYPES, run_navajo_pipeline  # noqa: E402
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Navajo County, AZ — end-to-end leads pipeline"
    )
    ...
    print("\n============================================================")
    print(" NAVAJO COUNTY AZ — REAL ESTATE LEADS PIPELINE")
    print("============================================================")
