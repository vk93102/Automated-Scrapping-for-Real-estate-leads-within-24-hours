...
from maricopa.llm_extract import _MODEL as GROQ_MODEL
...
print(f"  5. Extract fields via LLM ({GROQ_MODEL})")
...
print(f"   - LLM model = '{GROQ_MODEL}-tesseract-ocr' (OCR source)")
print(f"   - Or '{GROQ_MODEL}-metadata' (for failed OCR fallback)")
