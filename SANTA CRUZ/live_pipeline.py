...
# Allow running as: python3 "SANTA CRUZ/live_pipeline.py"
THIS_DIR = Path(__file__).resolve().parent
sys.path.insert(0, str(THIS_DIR))
sys.path.insert(0, str(THIS_DIR.parent))

from extractor import DEFAULT_DOCUMENT_TYPES, run_santacruz_pipeline  # noqa: E402
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Santa Cruz County, AZ — end-to-end leads pipeline"
    )
    ...
    print("\n============================================================")
    print(" SANTA CRUZ COUNTY AZ — REAL ESTATE LEADS PIPELINE")
    print("============================================================")
